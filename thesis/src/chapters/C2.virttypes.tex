...
added to \textbf{/etc/hosts} as following the example in \labelindexref{hosts file}{lst:etc-hosts}
...
\labelindexref{listing}{lst:etc-sudoers} to the \textbf{/etc/sudoers} file 
...
\subsection{Comments upon the implementation}
\label{sec:vmc-lxc-comments}

\todo{Short description of the outcome and its strong points}
...
\todo {describe the qcow2 format and the way it suits our needs}
